...
<head>
    ...
    <style>
        ...
        .destination-1 { left: 0%; transform: translateX(-50%); }
        .destination-2 { left: 33%; transform: translateX(-50%); }
        .destination-3 { left: 66%; transform: translateX(-50%); }
        .destination-4 { left: 100%; transform: translateX(-50%); }
    </style>
</head>
<body>
<div class="container">
    ...
    <section class="main">
        ...
        <div class="main-skills">
            ...
            <div class="card">
                ...
                <div>Time: <span id="current"><?php date_default_timezone_set('Asia/Dhaka'); echo date('h:i:s A');?></span></div>
                <table class="table">
                    <thead>
                        <tr>
                            <th>Location</th>
