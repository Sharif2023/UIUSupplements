...
<head>
    ...
    <style>
        ...
        .seat.taken {
            color: orange; /* Color for PICK */
        }
        .seat.dropped {
            color: #9ce3f3 ; /* Color for DROP */
        }
...
/* Main content */
.main {
    margin-left: 260px; /* Add margin to the right of the sidebar */
    padding: 20px;
    width: calc(100% - 260px); /* Adjust width to prevent overlapping */
}
...
<button class="btn"><a class="page-link" href="shulltequery.php">complex Query</a></button>
    ...
    document.getElementById('PICK').addEventListener('click', function() {
        if(currentSeat>totalSeats){alert("Full/empty");}
    ...
    document.getElementById('dropBtn').addEventListener('click', function() {
        if(currentSeat<=1){alert("Full/empty");}
...
<div class="col" id="map"></div> 
    ...
    let currentLocation = { lat: 23.797193, lng: 90.449684 };
    
    const destinations = {
        "NotunBazar": { lat: 23.797965, lng: 90.425739 },
        "Sayednagar": { lat:23.798630, lng:90.434937},
        "FamilyBazar": {lat:23.798195, lng:90.429263},
        "UIU": { lat: 23.797193, lng: 90.449684 }
    };
